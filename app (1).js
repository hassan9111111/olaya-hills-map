...
function resetPinchZoom() {
  ...
  // restore the original (zoom-enabled) viewport right after, so pinch
  // zoom keeps working normally everywhere else on the map
  window.setTimeout(() => meta.setAttribute("content", original), 60);
}
